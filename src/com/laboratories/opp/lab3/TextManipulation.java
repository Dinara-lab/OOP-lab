...
public class TextManipulation {
    public static void main(String[] args){
       String input = "Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical" +
        ...
        for (int i = 0; i<input.length();i++){
            if(Text.isVowel(input.charAt(i))){
             vowelCount++;
            }else if (!Text.isSymbol(input.charAt(i)) && input.charAt(i)>57 )
            {consonantCount++;}
        }
        ...
        System.out.println("Top 5 the most frequent words: " + Text.mostFrequentWord(input, 5));
